...
def unpack(source):
    ...
    if count != len(symtab):
        raise PackerError("Malformed p.a.c.k.e.r. symtab.")

    try:
        unbase = Unbaser(radix)
    except TypePackerError:
        raise PackerError("Unknown p.a.c.k.e.r. encoding.")
...
def _filterargs(source):
    ...
    for juicer in juicers:
        ...
        if args:
            ...
            except ValuePackerError:
                raise PackerError("Corrupted p.a.c.k.e.r. data.")
...
class Unbaser(object):
    ...
    def __init__(self, base):
        ...
        if 2 <= base <= 36:
            ...
            except KeyPackerError:
                raise TypePackerError("Unsupported base encoding.")
